...
_ADDRESBOOK = _descriptor.Descriptor(
  name='AddresBook',
  full_name='tutorial.AddresBook',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='people', full_name='tutorial.AddresBook.people', index=0,
...
AddresBook = _reflection.GeneratedProtocolMessageType('AddresBook', (_message.Message,), {
  ...
  '__module__' : 'addressbook_pb2'
  # @@protoc_insertion_point(class_scope:tutorial.AddresBook)
  })
