...
func (x *AddresBook) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AddresBook) ProtoMessage() {}

func (x *AddresBook) ProtoReflect() protoreflect.Message {
	mi := &file_addressbook_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AddresBook.ProtoReflect.Descriptor instead.
func (*AddresBook) Descriptor() ([]byte, []int) {
	return file_addressbook_proto_rawDescGZIP(), []int{1}
}

func (x *AddresBook) GetPeople() []*Person {
	if x != nil {
		return x.People
	}
	return nil
...
var file_addressbook_proto_rawDesc = []byte{
	...
	0x10, 0x01, 0x12, 0x08, 0x0a, 0x04, 0x57, 0x4f, 0x52, 0x4b, 0x10, 0x02, 0x22, 0x36, 0x0a, 0x0a,
	0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x42, 0x6f, 0x6f, 0x6b, 0x12, 0x28, 0x0a, 0x06, 0x70, 0x65,
	...
	0x6f, 0x70, 0x6c, 0x65, 0x42, 0x3c, 0x5a, 0x3a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_addressbook_proto_goTypes = []interface{}{
	...
	(*AddresBook)(nil),          // 2: tutorial.AddresBook
...
var file_addressbook_proto_depIdxs = []int32{
	...
	1, // 2: tutorial.AddresBook.people:type_name -> tutorial.Person
